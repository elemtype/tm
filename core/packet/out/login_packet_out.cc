...
void LoginPacketOut::gen_packet(){
  ...
  byte data4[]     = {0x00,0x01,0x00,0x00,0x00,0x1F,0x00,0x22,0x00,0x01};
  byte *data5      = rand_nbyte(32);
  //byte data5[]     = {0x44,0x1C,0xEA,0xD6,0xF5,0x76,0x99,0x3C,0x67,0x4C,0x3C,0xAC,0x6D,0x5C,0x65,0xA8,0xD1,0xCE,0x54,0x9A,0xCD,0x34,0x65,0x36,0x9C,0x71,0x1B,0x30,0x84,0x08,0xCE,0xA5};
  ...
  byte data13[]   = {0x91,0x79,0x7B,0xAA,0x0E,0x17,0xE9,0x57,0xE0,0x10,0xDF,0x86,0x05,0x7F,0xBE,0x47};
  byte data14[]   = {0x07};
  ...
  g_crc32[5] = 0x01;   //在0826_out包里，这位是0x00，但是这里变成了0x01，不然服务器不会响应。
